...
WHERE rc.customer_username = '$customer_username'
  AND rc.car_id = '$car_id'
ORDER BY rc.id DESC
LIMIT 1;";
    ...
    if ($result4 && mysqli_num_rows($result4) > 0) {
        ...
        echo "<div class='container'><div class='alert alert-danger'>Unable to fetch booking details. Please contact support.</div></div>";
    }
    ...
    <nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="color: black">
        ...
        <h2 class="text-center"> Thank you for using Vehicle Rental System! We wish you have a safe ride. </h2>
        ...
        <div class="container">
            ...
            <div class="box">
                ...
                <div class="col-md-10" style="float: none; margin: 0 auto; ">
                    ...
                    <br>
                    <h4> <strong>Owner Name:</strong>  <?php echo $client_name; ?></h4>
                    <br>
                    <h4> <strong>Owner Contact: </strong> <?php echo $client_phone; ?></h4>
                    <br>
                </div>
            </div>
