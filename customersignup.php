...
<head>
    <title> customer Signup | Vehicle Rentals  </title>
...
<body>
    ...
    <div class="container">
        <div class="jumbotron">
            <h1 class="text-center">Vehicle Rentals - Registration</h1>
            <br>
        ...
        <div class="col-md-5 col-md-offset-4">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <form role="form" action="customer_registered_success.php" method="POST" enctype="multipart/form-data">
                  ...
                  <label class="btn btn-primary"><span class="glyphicon glyphicon-envelope" aria-hidden="true"></label>
                        ...
                        <div class="row">
                            <div class="form-group col-xs-12">
                                ...
                                <div class="input-group">
                                <input class="form-control" id="client_phone" type="text" name="customer_phone" placeholder="Phone" required pattern="[0-9]{10}">
                                    <span class="input-group-btn">
                  <label class="btn btn-primary"><span class="glyphicon glyphicon-contact" aria-hidden="true"></span></label>
                        ...
                        <div class="row">
                            <div class="form-group col-xs-12">
                                ...
                                <div class="input-group">
                                    <input class="form-control" id="customer_address" type="text" name="customer_address" placeholder="Full Address" required>
                                    <span class="input-group-btn">
                  ...
                  <label class="btn btn-primary"><span class="glyphicon glyphicon-lock" aria-hidden="true"></span></label>
                        ...
                        <div class="row">
  <div class="form-group col-xs-12">
    <label for="license_number"><span class="text-danger">*</span> License Number:</label>
    <div class="input-group">
      <input class="form-control" id="license_number" type="text" name="license_number" placeholder="Driving License Number" required>
      <span class="input-group-btn">
        <label class="btn btn-primary"><span class="glyphicon glyphicon-credit-card" aria-hidden="true"></span></label>
      </span>
    </div>
  </div>
</div>
...
<div class="row">
  <div class="form-group col-xs-12">
    <label for="license_file"><span class="text-danger">*</span> Upload License (Image/PDF):</label>
    <input class="form-control" id="license_file" type="file" name="license_file" accept=".jpg,.jpeg,.png,.pdf" required>
  </div>
</div>
