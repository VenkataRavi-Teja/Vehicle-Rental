...
?>
    ...
    <div class="container">
        <div class="jumbotron">
            <h1 class="text-center" style="color: green;"><span class="glyphicon glyphicon-ok-circle"></span> Vehicle Returned</h1>
        </div>
    </div>
    <br>

    <h2 class="text-center"> Thank you for visiting Vehicle Rentals! We wish you have a safe ride. </h2>
    ...
    <div class="container">
        ...
        <div class="box">
            ...
            ?></h4>
                ...
                <br>
                <h4> <strong>Vehicle Return Date: </strong> <?php echo $car_return_date; ?> </h4>
                <br>
