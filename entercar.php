    ...
    <div class="col-md-7" style="float: none; margin: 0 auto;">
      <div class="form-area">
        ...
        <br style="clear: both">
          ...
          <div class="form-group">
    <input type="text" class="form-control" id="ac_price" name="ac_price" placeholder="AC Fare per KM (Rs)" required pattern="[0-9]+" title="Please enter only numbers">
</div>

<div class="form-group">
    <input type="text" class="form-control" id="non_ac_price" name="non_ac_price" placeholder="Non-AC Fare per KM (Rs)" required pattern="[0-9]+" title="Please enter only numbers">
</div>

<div class="form-group">
    <input type="text" class="form-control" id="ac_price_per_day" name="ac_price_per_day" placeholder="AC Fare per day (Rs)" required pattern="[0-9]+" title="Please enter only numbers">
</div>

<div class="form-group">
    <input type="text" class="form-control" id="non_ac_price_per_day" name="non_ac_price_per_day" placeholder="Non-AC Fare per day (Rs)" required pattern="[0-9]+" title="Please enter only numbers">
</div>
...
<div style="overflow-x:auto;">
  ...
  <?php } ?>
    ...
    <br>
  <?php } else { ?>
  <h4><center>0 Vehicles available</center> </h4>
  <?php } ?>
        </form>
</div>        
        </div>
