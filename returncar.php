...
function dateDiff($start, $end) {
 ...
 $id = $_GET["id"];
$sql1 = "SELECT c.car_id, c.car_name, c.car_nameplate, rc.rent_start_date, rc.rent_end_date, rc.fare, rc.charge_type
         FROM rentedcars rc, cars c
         WHERE rc.id = '$id' AND c.car_id = rc.car_id";
...
?>
      ...
      <div class="form-area">
        ...
        <br style="clear: both">
          ...
          <h6 style="margin-bottom: 25px; text-align: center; font-size: 12px;"> Allow your driver to fill the below form </h6>
           ...
           <h5> Vehicle:&nbsp;  <?php echo($car_name);?></h5>
    ...
    <form action="submit_review.php" method="POST">
        ...
        <input type="hidden" name="username" value="<?php echo $_SESSION['login_customer']; ?>">
...
<?php else: ?>
    <p><a href="login_customer.php">Log in</a> to leave a review.</p>
<?php endif; ?>
